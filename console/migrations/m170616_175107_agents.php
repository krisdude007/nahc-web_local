...
//    }
    ...
    public function up()
    {
        ...
        $this->batchInsert('user',
            ['username', 'password_hash', 'auth_key', 'email', 'has_agent', 'created_at', 'updated_at'],
            [
                ['steve.wendlandt',     Yii::$app->security->generatePasswordHash('temp_140954'),   Yii::$app->security->generateRandomString(),    'stevew@selectedbenefits.com',          true,   $ts,    $ts],
                ['todd.madrid',         Yii::$app->security->generatePasswordHash('temp_140972'),   Yii::$app->security->generateRandomString(),    'toddmcic@gmail.com',                   true,   $ts,    $ts],
                ['mark_harris',         Yii::$app->security->generatePasswordHash('temp_140987'),   Yii::$app->security->generateRandomString(),    'markdharris@cox.net',                  true,   $ts,    $ts],
                ['bob.jabour',          Yii::$app->security->generatePasswordHash('temp_141011'),   Yii::$app->security->generateRandomString(),    'bob@texashealthnow.com',               true,   $ts,    $ts],
                ['grace.tornik',        Yii::$app->security->generatePasswordHash('temp_141072'),   Yii::$app->security->generateRandomString(),    'gracetornik@yahoo.com',                true,   $ts,    $ts],
                ['reed.hitch',          Yii::$app->security->generatePasswordHash('temp_141093'),   Yii::$app->security->generateRandomString(),    'reedhitch@msn.com',                    true,   $ts,    $ts],
                ['chris.ford',          Yii::$app->security->generatePasswordHash('temp_141165'),   Yii::$app->security->generateRandomString(),    'chris.ford1@cox.net',                  true,   $ts,    $ts],
                ['rick.hamilton',       Yii::$app->security->generatePasswordHash('temp_141182'),   Yii::$app->security->generateRandomString(),    'rick.health@yahoo.com',                true,   $ts,    $ts],
                ['steve.herman',        Yii::$app->security->generatePasswordHash('temp_141253'),   Yii::$app->security->generateRandomString(),    'steveherman68@sbcglobal.net',          true,   $ts,    $ts],
                ['ao.insurance',        Yii::$app->security->generatePasswordHash('temp_141295'),   Yii::$app->security->generateRandomString(),    'lisa.aoinsagency@gmail.com',           true,   $ts,    $ts],
                ['phil.raskin',         Yii::$app->security->generatePasswordHash('temp_141326'),   Yii::$app->security->generateRandomString(),    'lisamcconville2013@gmail.com',         true,   $ts,    $ts],
                ['charles_harrell',     Yii::$app->security->generatePasswordHash('temp_141335'),   Yii::$app->security->generateRandomString(),    'c.harrell@allaboardbenefits.net',      true,   $ts,    $ts],
                ['greg_myers',          Yii::$app->security->generatePasswordHash('temp_141420'),   Yii::$app->security->generateRandomString(),    'greg@health-quotes.com',               true,   $ts,    $ts],
                ['ryan.howell',         Yii::$app->security->generatePasswordHash('temp_141483'),   Yii::$app->security->generateRandomString(),    'protectiveplanning@hotmail.com',       true,   $ts,    $ts],
                ['taryn.collins',       Yii::$app->security->generatePasswordHash('temp_141553'),   Yii::$app->security->generateRandomString(),    'taryn@streamlinebg.com',               true,   $ts,    $ts],
                ['james.rippel',        Yii::$app->security->generatePasswordHash('temp_141612'),   Yii::$app->security->generateRandomString(),    'jim@chsmkting.com',                    true,   $ts,    $ts],
                ['reginald.jackson',    Yii::$app->security->generatePasswordHash('temp_141768'),   Yii::$app->security->generateRandomString(),    'reggiej@rjinsures.com',                true,   $ts,    $ts],
                ['daniel.moen',         Yii::$app->security->generatePasswordHash('temp_141820'),   Yii::$app->security->generateRandomString(),    'danielsinbox@yahoo.com',               true,   $ts,    $ts],
                ['todd_madrid',         Yii::$app->security->generatePasswordHash('temp_141875'),   Yii::$app->security->generateRandomString(),    'tmadrid45@gmail.com',                  true,   $ts,    $ts],
                ['charity.bliss',       Yii::$app->security->generatePasswordHash('temp_141896'),   Yii::$app->security->generateRandomString(),    'charityblissinc@gmail.com',            true,   $ts,    $ts],
                ['sean.collins',        Yii::$app->security->generatePasswordHash('temp_141908'),   Yii::$app->security->generateRandomString(),    'collins4s@sbcglobal.net',              true,   $ts,    $ts],
                ['scott_eckley',        Yii::$app->security->generatePasswordHash('temp_141916'),   Yii::$app->security->generateRandomString(),    'seckley@apollo-insurance.com',         true,   $ts,    $ts],
