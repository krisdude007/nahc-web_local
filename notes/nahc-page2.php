...
//        ],
    ...
    if (Yii::$app->user->isGuest) {
        $loginItems[] = ['label' => 'Login', 'url' => ['/site2/login']];
        $loginItems[] = '<li>'.Html::a('Join Now',[ '/site2/signup'], ['class' => 'btn btn-primary']).'</li>';
    } else {
        $loginItems[] = '<li>'.Html::a('Membership',[ '/site2/dashboard'], ['class' => 'btn btn-primary']).'</li>';
        $loginItems[] = '<li>'
