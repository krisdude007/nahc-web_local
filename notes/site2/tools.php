...
<div class="site-tools">
    ...
    <div class="jumbotron jumbo-top" style="background-image: url('/img/jumbo-tools.jpg');">
    ...
    <div class="body-content">
        <div class="row">
            <div class="col-sm-10 col-sm-offset-1">
                <h1>Your NAHC Membership provides tools and resources to compare costs, evaluate quality, and find the best care at the best price.</h1>
            </div>
        </div>
        <div class="row text-left">
            ...
            <div class="col-sm-7">
                ...
                <p>The price you pay for the same procedures can vary from one doctor to the next. We help to ensure that you choose the right doctor at the right price.</p>
                <p>
                ...
                <a href="#tools1" data-toggle="modal" data-target="#tools1" class="btn btn-default">More Details</a>&nbsp;&nbsp;
        ...
        <div class="row text-right">
            <div class="col-sm-7 col-sm-offset-1 text-right">
                ...
                <p>Not all healthcare facilities are equal. NAHC helps you compare costs of hospitals, clinics and medical centers to help you select the right one for you.</p>
                <p> • Identify hospitals in your area rated 3-stars or higher<br>
                    • Confirm your doctor can treat you at a specific facility<br>
                    • Provide cost-comparison reviews and research<br> </p>
                <a href="#tools2" data-toggle="modal" data-target="#tools2" class="btn btn-default">More Details</a>&nbsp;&nbsp;<a href="#" class="btn btn-primary">Join Now!</a>
            </div>
            <div class="col-sm-3 ">
                <img src="/img/tools-1.jpg" width="100%">
            </div>
        ...
        <div class="row text-left">
            ...
            <div class="col-sm-7">
                ...
                <p>Get qualified and unbiased reports on the quality ratings, service records, and overall reputations of healthcare providers and the facilities they use. </p>
                <p> • Evaluations of healthcare-facility quality<br>
                    • Reviews on the reputations of doctors and clinicians<br>
                    • Research and reports on patient satisfaction<br>
                </p>
                <a href="#tools3" data-toggle="modal" data-target="#tools3" class="btn btn-default">More Details</a>&nbsp;&nbsp;
                <a href="#" class="btn btn-primary">Join Now!</a>
            </div>
        </div>
        <div class="row text-right">
            <div class="col-sm-7 col-sm-offset-1 text-right">
                ...
                <p>For Members with questions or concerns about procedures and diagnoses, NAHC can assist you with the answers, advice and information you need.</p>
                <p>
                    • Second-opinion referrals<br>
                    • Reference materials on diagnoses<br>
                    • Information on treatment options<br>
                </p>
                <a href="#tools4" data-toggle="modal" data-target="#tools4" class="btn btn-default">More Details</a>&nbsp;&nbsp;
                <a href="#" class="btn btn-primary">Join Now!</a>
            </div>
            <div class="col-sm-3 ">
                <img src="/img/tools-1.jpg" width="100%">
