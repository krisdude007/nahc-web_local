...
<div class="site-membership">
    ...
    <div class="body-content">
        ...
        <a name="mem1" id="mem1"></a>
        <div class="row text-left">
            <div class="col-sm-4 col-lg-3 col-lg-offset-1">
                <img src="/img/icon/icon-card.png" width="100%">
            </div>
            <div class="col-sm-8 col-lg-7">
                <h1>Discount RX Prescription Card</h1>
                <p>The NAHC Discount Prescription Drug Card is free and gets you and your family immediate discounts on prescription drugs at over 59,000 pharmacies nationwide.</p>
                <div class="row">
                    <div class="col-sm-6">
                        <h4>Benefits</h4>
                        <ul>
                            <li>A Free Prescription Drug Discount Card</li>
                            <li>Discounts at over 59,000 pharmacies nationwide</li>
                            <li>Access to on-line pharmacy look up</li>
                            <li>Can be used by your entire family</li>
                            <li>Immediate prescription discounts on payment</li>
                        </ul>
                    </div>
                    <div class="col-sm-6">
                        <h4>Benefits</h4>
                        <ul>
                            <li>No monthly fees, no costs for use of the card</li>
                            <li>Immediate savings, averaging 50% or more</li>
                            <li>Discounts at pharmacies convenient to you</li>
                            <li>Lower family’s out-of-pocket prescription costs</li>
                            <li>Do not have to wait, get immediate cost savings</li>
                        </ul>
                    </div>
                </div>
                <a href="#plans" class="btn btn-default">Compare Plans</a>&nbsp;&nbsp;<a href="#" class="btn btn-primary">Join Now!</a>
            </div>
        </div>
        <hr>
        <a name="mem2" id="mem2"></a>
        <div class="row text-right">
            <div class="col-sm-8 col-lg-7 col-lg-offset-1 text-right">
                <h1>Discount Medical Provider Networks</h1>
                <p>NAHC Members get access to a nationwide network of doctors and other healthcare providers, who provide immediate discounts at time of service for Members paying cash.</p>
                <div class="row">
                    <div class="col-sm-6">
                        <h4>Benefits</h4>
                        <ul>
                            <li>Free Member Access to the provider discount network</li>
                            <li>Discounts at over 59,000 pharmacies nationwide</li>
                            <li>Access to on-line pharmacy look up</li>
                            <li>Can be used by your entire family</li>
                            <li>Immediate prescription discounts on payment</li>
            ...
            <div class="col-sm-4 col-lg-3">
                <img src="/img/icon/icon-networks.png" width="100%">
            </div>
        </div>
        <hr>
        <a name="mem3" id="mem3"></a>
        <div class="row text-left">
            <div class="col-sm-4 col-lg-3 col-lg-offset-1">
                <img src="/img/icon/icon-quality.png" width="100%">
            </div>
            <div class="col-sm-8 col-lg-7">
                <h1>Doctor & Hospital Quality Reports</h1>
                <p>NAHC Members get access to on-line doctor and hospital reviews and quality ratings nationwide, so our Members can make informed decisions when choosing the best provider for their medical needs.</p>
                <div class="row">
                    <div class="col-sm-6">
                        <h4>Benefits</h4>
                        <ul>
                            <li>Search on-line to find a doctor near you or nationwide</li>
                            <li>Search on-line to find a dentist near you or nationwide</li>
                            <li>See on-line reviews for a doctor</li>
                            <li>Determine which insurance is accepted by the doctor</li>
                        </ul>
                    </div>
                    <div class="col-sm-6">
                        <h4>Benefits</h4>
                        <ul>
                            <li>See a star rating system for doctors and dentists</li>
                            <li>Identify a doctor or dentist by medical practice specialty</li>
                            <li>Be able to submit an on-line review of a doctor</li>
                            <li>Review the doctor’s education and background</li>
                        </ul>
                    </div>
                </div>
                <a href="#plans" class="btn btn-default">Compare Plans</a>&nbsp;&nbsp;<a href="#" class="btn btn-primary">Join Now!</a>
        ...
        <hr>
        <a name="mem4" id="mem4"></a>
        <div class="row text-right">
            <div class="col-sm-8 col-lg-7 col-lg-offset-1 text-right">
                <h1>Healthcare Pricing Transparency</h1>
                <p>NAHC Members get access to on-line doctor and hospital pricing nationwide, so our Members can find the best most cost effective solutions for their medical needs.</p>
                <div class="row">
                    <div class="col-sm-6">
                        <h4>Benefits</h4>
                        <ul>
                            <li>See what doctors and hospitals typically charge</li>
                            <li>Find the typical cost for any medical procedure</li>
                            <li>Identify doctors with the best reputation and best prices</li>
                            <li>See what a surgical procedure will cost</li>
                        </ul>
                    </div>
                    <div class="col-sm-6">
                        <h4>Benefits</h4>
                        <ul>
                            <li>Stop over paying for healthcare</li>
                            <li>Learn what a Fair Price is for any medical procedure</li>
                            <li>Identify the best quality doctor to got to for surgery</li>
                            <li>Learn what different hospitals charge for same procedure</li>
                        </ul>
                    </div>
                </div>
                <a href="#plans" class="btn btn-default">Compare Plans</a>&nbsp;&nbsp;<a href="#" class="btn btn-primary">Join Now!</a>
            ...
            <div class="col-sm-4 col-lg-3">
                <img src="/img/icon/icon-transparency.png" width="100%">
            </div>
        </div>
        <hr>
        <a name="mem5" id="mem5"></a>
        <div class="row text-left">
            <div class="col-sm-4 col-lg-3 col-lg-offset-1">
                <img src="/img/icon/icon-travel.png" width="100%">
            </div>
            <div class="col-sm-8 col-lg-7">
                <h1>Worldwide Medical Travel Assistance</h1>
                <p>NAHC Members get access to emergency medical service when traveling domestically or worldwide.</p>
                <div class="row">
                    <div class="col-sm-6">
                        <h4>Benefits</h4>
                        <ul>
                            <li>24/7 emergency medical evacuation on traveling</li>
                            <li>Providing real-time assistance anywhere in the world</li>
                            <li>Provides Air Ambulance service if needed</li>
                            <li>Provides turnkey logistical support for all types of evacuations</li>
                        </ul>
                    </div>
                    <div class="col-sm-6">
                        <h4>Benefits</h4>
                        <ul>
                            <li>Emergency medical transportation worldwide</li>
                            <li>35+ multilingual assistance centers worldwide</li>
                            <li>Assistance with medical search and approvals</li>
                            <li>Coordination of return travel to U.S. in medical emergency</li>
                        </ul>
                    </div>
                </div>
                <a href="#plans" class="btn btn-default">Compare Plans</a>&nbsp;&nbsp;<a href="#" class="btn btn-primary">Join Now!</a>
        ...
        <hr>
        <a name="mem6" id="mem6"></a>
        <div class="row text-right">
            <div class="col-sm-8 col-lg-7 col-lg-offset-1 text-right">
                <h1>24/7 Tele-Medical Access</h1>
                <p>NAHC Members get 24/7 on-line access, 365 days a year to medical providers anywhere in the U.S., and from the convenience of one’s home, office, or even on vacation.</p>
                <div class="row">
                    <div class="col-sm-6">
                        <h4>Benefits</h4>
                        <ul>
                            <li>See a medical professional on-line, immediately</li>
                            <li>Access a provider on-line from home, work, vacation</li>
                            <li>No need to set an appointment to see a provider</li>
                            <li>For most ailments, you get diagnosis and treatment on-line</li>
                            <li>Speak with a board-certified licensed medical provider</li>
                        </ul>
                    </div>
                    <div class="col-sm-6">
                        <h4>Benefits</h4>
                        <ul>
                            <li>When medically necessary, get an e-prescription</li>
                            <li>24/7 On-line access to a medical professional</li>
                            <li>More affordable than a doctor’s visit</li>
                            <li>Secure on-line access, with confidential diagnoses</li>
                            <li>Costs less than most co-pays</li>
                        </ul>
                    </div>
                </div>
                <a href="#plans" class="btn btn-default">Compare Plans</a>&nbsp;&nbsp;<a href="#" class="btn btn-primary">Join Now!</a>
            ...
            <div class="col-sm-4 col-lg-3">
                <img src="/img/icon/icon-tele.png" width="100%">
            </div>
        </div>
        <hr>
        <a name="mem7" id="mem7"></a>
        <div class="row text-left">
            <div class="col-sm-4 col-lg-3 col-lg-offset-1">
                <img src="/img/icon/icon-advocacy.png" width="100%">
            </div>
            <div class="col-sm-8 col-lg-7">
                <h1>Personal Healthcare Advocacy</h1>
                <p>NAHC Members get access to a personal healthcare advocate you can advise and lobby on behalf of the Member; on costs for healthcare services, best insurance and understanding the benefits, and medical billing.</p>
                <div class="row">
                    <div class="col-sm-6">
                        <h4>Benefits</h4>
                        <ul>
                            <li>Get help on understanding insurance plans & benefits</li>
                            <li>Access a physician referral service</li>
                            <li>Find tips on preparing for surgery or hospitalization</li>
                            <li>Get costs estimates for surgery before you go in for surgery</li>
                        </ul>
                    </div>
                    <div class="col-sm-6">
                        <h4>Benefits</h4>
                        <ul>
                            <li>Get help on finding the right physician specialist</li>
                            <li>Medical Bill Auditing and Dispute Services</li>
                            <li>More affordable than a doctor’s visit</li>
                            <li>Get estimates on prescription costs and generic drugs</li>
                            <li>Get advice on the best hospital for a specific specialty</li>
                        </ul>
                    </div>
                </div>
                <a href="#plans" class="btn btn-default">Compare Plans</a>&nbsp;&nbsp;<a href="#" class="btn btn-primary">Join Now!</a>
        ...
        <hr>
        <a name="mem8" id="mem8"></a>
        <div class="row text-right">
            <div class="col-sm-8 col-lg-7 col-lg-offset-1 text-right">
                <h1>AnyDoctor</h1>
                <p>Have an advocate negotiate with doctors and other healthcare providers and determine a price for you, before you visit the doctor’s office.</p>
                <div class="row">
                    <div class="col-sm-6">
                        <h4>Benefits</h4>
                        <ul>
                            <li>Get help finding the right doctor for a specialized procedure</li>
                            <li>Get help determining a discounted cash price for a doctor’s visit</li>
                            <li>Reduce your costs of primary care visits</li>
                            <li>Find a hospital best suited for your surgery</li>
                        </ul>
                    </div>
                    <div class="col-sm-6">
                        <h4>Benefits</h4>
                        <ul>
                            <li>Get help negotiating the cost of a doctor visit</li>
                            <li>Have someone find you the best doctor for a specialty</li>
                            <li>Have someone determine if there are hidden costs</li>
                            <li>Get help negotiating the cost of surgery</li>
                        </ul>
                    </div>
                </div>
                <a href="#plans" class="btn btn-default">Compare Plans</a>&nbsp;&nbsp;<a href="#" class="btn btn-primary">Join Now!</a>
            ...
            <div class="col-sm-4 col-lg-3">
                <img src="/img/icon/icon-anydoctor.png" width="100%">
            </div>
        </div>
