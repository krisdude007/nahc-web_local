...
<div class="member-welcome">
    ...
    <p><strong>Welcome to the National Association for Healthcare Consumers</strong> - Thank you for your enrollment in NAHC.  We believe that you will find our products and services to be very beneficial. For more details about your NAHC membership, click this link to register as a new user <a href="<?= isset($_SERVER['HTTPS']) ? "https://" : "http://". $_SERVER['HTTP_HOST'] ?>/signup/<?=$member->init_user_hash?>"><?= isset($_SERVER['HTTPS']) ? "https://" : "http://". $_SERVER['HTTP_HOST']?>/signup/<?=$member->init_user_hash?></a></p>

    <!--<p><strong>To create your website login</strong> - Click the following link and select a username and password - <a href="https://joinnahc.com/signup/<?=$member->init_user_hash;?>">https://joinnahc.com/signup/<?=$member->init_user_hash;?></a></p>-->

    <p><strong>Identification Cards</strong> - In the coming days, you will be receiving a welcome packet that will include your Identification Cards. When you use your membership benefits, you will be asked for your NAHC Member ID Number, so keep your ID cards where they are easily accessible.  If you forget your Member ID Number or password, you can visit our website to retrieve them.  Temporary ID cards can also be printed from the website on the “My Membership” page, located at <a href="<?= isset($_SERVER['HTTPS']) ? "https://" : "http://". $_SERVER['HTTP_HOST']?>/member"><?= isset($_SERVER['HTTPS']) ? "https://" : "http://". $_SERVER['HTTP_HOST']?>/member</a>.</p>
