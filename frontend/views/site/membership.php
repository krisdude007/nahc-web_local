...
<!--                <p>The following membership packages are available from NAHC today!</p>-->
<!--            </div>-->
<!--        </div>-->
        <div class="row">
            <div class="col-sm-10 col-sm-offset-1">
                <h1>Membership Benefits & Plans</h1>
                <p class="lead">Select a membership benefit to learn more, or click "Join Now" to buy a plan today!</p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-10 col-sm-offset-1">
                <h1>NAHC Exclusive Membership Benefits</h1>
                <p class="lead">Explore our exclusive, member-only benefits below.</p>
            </div>
        </div>

<?php   $i = 0;
        foreach($benefits as $benefit) {
           $minLevel = $benefit->getMinimumMembershipLevel();
            ?>
                <a name="mem<?=$benefit->id?>" id="mem<?=$benefit->id?>"></a>
                <img src="/img/icon/<?=$benefit->icon?>.png" class="img-responsive center-block visible-xs feature-icon-xs">
                <div class="row content-row text-left feature-row">
                    <?php if($i % 2 == 0) { ?>
                    <div class="col-sm-3 col-lg-3 col-lg-offset-1">
                        <img src="/img/icon/<?=$benefit->icon?>.png" class="img-responsive center-block">
                    </div>
                <?php } ?>
                    <div class="col-sm-9 col-lg-7 <?=($i%2==1?'col-lg-offset-1':'')?>">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <dl>
                                    <dt>Features</dt>
                                    <?=implode(PHP_EOL, array_map( function ($b) { return '<dd>'.$b.'</dd>';}, explode('::', $benefit->features)));?>
                                    <?=implode(PHP_EOL, array_map( function ($b) { return '<dd class="visible-xs">'.$b.'</dd>';}, explode('::', $benefit->features2)));?>
                                </dl>
                            </div>
                            <div class="col-sm-6">
                                <dl class="hidden-xs">
                        ...
                        <a href="#plan<?=$minLevel?>" class="btn btn-default">Compare Plans</a>&nbsp;&nbsp;
                        <?php if (0 < $level && $level < $minLevel) { ?>
                        <a href="<?= Url::to(['member/upgrade', 'plan' => $minLevel]) ?>" class="btn btn-success">Upgrade Now!</a>
                        <?php } elseif ($level >= $minLevel) { ?>
                            <a href="<?= Url::to(['member/index', '#'=>'mem'.$benefit->id]) ?>" class="btn btn-info">Use Benefit</a>
                        <?php } elseif ($level == 0) { ?>
                            <a href="<?= Url::to(['site/join', 'plan' => $minLevel]) ?>" class="btn btn-primary">Join Now!</a>
                        <?php } ?>
                    </div>
                    <?php if($i % 2 == 1) { ?>
                        <div class="col-sm-3 col-lg-3 col-lg-offset-1">
...
<?php       $i++;
        ...
        <div class="row nahc-bg-gr-ult content-row">
            <div class="col-sm-10 col-sm-offset-1">
                ...
                <div class="collapse" id="faq1">
                    Click on the "Join" link at the top of this page. You will then begin the enrollment process. If you do not want to complete your enrollment online, please contact your agent for other available options.
                </div>
                </p>
                <p>
                ...
                <div class="collapse" id="faq3">
                    If you enroll in a program today, access to the benefits and services will be effective on the first day of next month, subject to acceptance by NAHC.
                ...
                <div class="collapse" id="faq5">
                    ...
                    If you are an employer with a minimum of 5 enrollees, NAHC can list bill your group for the monthly dues. Please see your agent for details.
                </div>
                </p>
            </div>
        </div>
